...
namespace ConductTempControl_ForPC
{
    static class IniReadWrite
    {
        ...
        public static string[] INIGetAllSectionNames(string iniFile)
        {
            ...
            uint bytesReturned = IniReadWrite.GetPrivateProfileSectionNames(pReturnedString, MAX_BUFFER, iniFile);
            if (bytesReturned != 0)
            {
                //读取指定内存的内容
        ...
        public static string[] INIGetAllItems(string iniFile, string section)
        {
            ...
            uint bytesReturned = IniReadWrite.GetPrivateProfileSection(section, pReturnedString, MAX_BUFFER, iniFile);
        ...
        public static string[] INIGetAllItemKeys(string iniFile, string section)
        {
            ...
            uint bytesReturned = IniReadWrite.GetPrivateProfileString(section, null, null, chars, SIZE, iniFile);
        ...
        public static string INIGetStringValue(string iniFile, string section, string key, string defaultValue)
        {
            ...
            uint bytesReturned = IniReadWrite.GetPrivateProfileString(section, key, defaultValue, sb, SIZE, iniFile);
        ...
        public static bool INIWriteItems(string iniFile, string section, string items)
        {
            ...
            return IniReadWrite.WritePrivateProfileSection(section, items, iniFile);
        }
        ...
        public static bool INIWriteValue(string iniFile, string section, string key, string value)
        {
            ...
            return IniReadWrite.WritePrivateProfileString(section, key, value, iniFile);
        ...
        public static bool INIDeleteKey(string iniFile, string section, string key)
        {
            ...
            return IniReadWrite.WritePrivateProfileString(section, key, null, iniFile);
        }
        ...
        public static bool INIDeleteSection(string iniFile, string section)
        {
            ...
            return IniReadWrite.WritePrivateProfileString(section, null, null, iniFile);
        }
        ...
        public static bool INIEmptySection(string iniFile, string section)
        {
            ...
            return IniReadWrite.WritePrivateProfileSection(section, string.Empty, iniFile);
        }
